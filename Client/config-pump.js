module.exports = {
    entity: {
        subscribe: [
            ...
            "input_boolean.auto_irrigation",
            "input_boolean.enable_bubon",
            "input_boolean.enable_irrigation",
            ...
            dd: [       // config for the Demand/Delivery automation function, 1 object for each DD system
                {   // DD system example
                    ...
                    control: {
                        ...
                        enable: "input_boolean.enable_bubon",
                ...
                {                           // DD system example
                    ...
                    enable: false,
                    control: {
                        auto: "input_boolean.auto_irrigation",                 // home assistant auto toggle ID number (specified above in cfg.ha config)
                        enable: "input_boolean.enable_irrigation",
